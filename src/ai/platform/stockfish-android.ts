// stockfish-android.ts
import { NativeModules } from 'react-native';
const { StockfishModule } = NativeModules;

export class StockfishAndroid {
  // Similar implementation to iOS version
  // The methods are the same, but the underlying implementation will differ
